...
final Map AppManifestSchema =
{
  ...
  "background_page": "string",  // 遗产（清单V1）
  "bluetooth": {
    "uuids": ["string"],
    "socket": "boolean",
    "low_energy": "boolean"
  ...
  "browser_action": {
    "icons": ["string"],
    "id": "string",
    "default_icon": "var",  //词典（“串”，“串”）|| “串”= Dictionary("string", "string") || "string"
  ...
  "requirements": {
    ...
    "3D": {
      "features!": ["3d_feature"] // “webgl的”或“css3d”
    },
    "plugins": {
      "<meta-open-ended>": false,
      "npapi": "boolean"
...
/**
 * 模式为“USB设备”权限项。(Schema for the "usbDevices" permission entry.
 */
